...
namespace SignUp.Migrations
{
    ...
    [Migration("20260225012701_updateannauncmen3")]
    partial class updateannauncmen3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$xIjmFQ9fBkVQVOQJF6pjZeBHpFjhMM.Gq9C0VKi4kOpEYCLpqQW7W",
                            Phone = "01000000000",
                            Role = "Admin"
                        });
                });

            modelBuilder.Entity("ClubManagementAPI.Models.GuestRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DesiredPackage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.MemberProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.MemberSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.TrainerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.TrainingSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignUp.Model.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.GuestRequest", b =>
                {
                    b.HasOne("ClubManagementAPI.Models.ApplicationUser", "User")
                        .WithOne("GuestRequest")
                        .HasForeignKey("ClubManagementAPI.Models.GuestRequest", "UserId")
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.MemberProfile", b =>
                {
                    b.HasOne("ClubManagementAPI.Models.TrainerProfile", "AssignedTrainer")
                        .WithMany()
                    ...
                    b.HasOne("ClubManagementAPI.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("ClubManagementAPI.Models.MemberProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.MemberSession", b =>
                {
                    b.HasOne("ClubManagementAPI.Models.MemberProfile", "MemberProfile")
                        .WithMany("MemberSessions")
                        .HasForeignKey("MemberProfileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ClubManagementAPI.Models.TrainingSession", "TrainingSession")
                        .WithMany("MemberSessions")
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.TrainerProfile", b =>
                {
                    b.HasOne("ClubManagementAPI.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("ClubManagementAPI.Models.TrainerProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ClubManagementAPI.Models.TrainingSession", b =>
                {
                    b.HasOne("ClubManagementAPI.Models.TrainerProfile", "Trainer")
                        .WithMany("Sessions")
